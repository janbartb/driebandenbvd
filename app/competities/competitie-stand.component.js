System.register(['@angular/core', '@angular/router', "./competitie.service", "../api/competitie.api.service", "./competitie-stand.pipe"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, competitie_service_1, competitie_api_service_1, competitie_stand_pipe_1;
    ...
    return {
        ...
        execute: function() {
            CompetitieStandComponent = (function () {
                function CompetitieStandComponent(route, router, compService, apiService) {
                    this.route = route;
                    this.router = router;
